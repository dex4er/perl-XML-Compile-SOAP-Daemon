...
of the messages is handled by various L<XML::Compile::SOAP|XML::Compile::SOAP> packages,
based on L<XML::Compile|XML::Compile>.  The processing of the message is handled by
L<XML::Compile::SOAP::Daemon|XML::Compile::SOAP::Daemon>.
...
for any SOAP1.1 and SOAP1.2 mixture.  Although L<XML::Compile::SOAP|XML::Compile::SOAP>
...
This module is part of XML-Compile-SOAP-Daemon distribution version 0.11,
