...
$obj-E<gt>B<addSoapAction>(HASH|PAIRS)
...
$obj-E<gt>B<addWsaTable>(('INPUT'|'OUTPUT'), [HASH|PAIRS])
...
The XMLIN SOAP-structured message (an XML::LibXML::Element,
...
This module is part of XML-Compile-SOAP-Daemon distribution version 2.05,
built on December 13, 2010. Website: F<http://perl.overmeer.net/xml-compile/>
